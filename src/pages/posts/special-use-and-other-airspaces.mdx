---
slug: special-use-and-other-airspaces
title: Special Use and Other Airspaces
date: 2020-10-08
author: IvanParra
tags:
  - aviation
...
![prohibited airspace](/images/prohibited-areas.png "prohibited airspace")

Prhibited areas are usually created for security or national welfare.

They are depicted in the sectional chart with blue hatched borders and labeled with the letter P. Operations are totally prohibited within the area.
...
Depicted in the sectional chart with blue hatched borders and labeled with the letter R.
...
Depicted in the sectional chart with blue hatched borders and labeled with the letter W.
...
MOAs are areas created to separate certain military training activities from non-participating traffic. When the MOA is active (hot) ATC will re-route IFR traffic around the area unless traffic separation can be provided. No clearance is required for VFR traffic, therefore they can cross over an MOA without talking with ATC, although it is not recommended.
...
![Alert area](/images/alert-area.png "Aler area")

Alerta areas are those which may contain a high volume of pilot training or an unusual type of aerial activity. Pilots can enter the area but they should exercise caution.
...
CFA are areas that contain activities that, if not conducted in a controlled environment, could be hazardous to nonparticipating aircraft.
...
As a pilot, we can find more information about SUA on the left side of a sectional chart. This information (SUA altitudes, hours of operation, controlling agency, and frequencies) will help us to determine if the flight can be conducted in the area or if we should plan something different.

![USA Legend](/images/usa-legend.png "USA Legend")

We can also find a dynamic map and the current status of SUA on the following website - [SUA FAA website](https://sua.faa.gov/sua/siteFrame.app)

So next time you are planning a VFR cross country, take your time, look at the chart, identify the SUA, and contact the corresponding agency if you have any doubt.
